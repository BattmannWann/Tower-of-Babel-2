...
; 2. THE VB-CABLE DRIVER (Point this to where it is extracted)
Source: "C:\Users\rhysi\Downloads\VBCABLE_Driver_Pack45\VBCABLE_Setup_x64.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall
...
[Run]
; Silently install the audio cable BEFORE opening the app
Filename: "{tmp}\VBCABLE_Setup_x64.exe"; Parameters: "-i -h"; Flags: waituntilterminated runhidden
